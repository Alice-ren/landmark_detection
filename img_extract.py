...
data=pd.read_csv('/home/rentingting/data/kaggle/test.csv')
detect_result = pd.read_csv('/home/rentingting/project/mtcnn/MTCNN_Caffe/examples/LKSrc/landmark_detection/scripts/fkp_output.csv')
